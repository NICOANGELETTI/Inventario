...
<html>
    <head>
        ...
        <title>Editar de Produtos</title>
         <style>
            .footer {
                background-color: #FFD03F; /* Fondo de color warning */
                color: black;
                text-align: center;
                padding: 10px;
            }
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/ServletControlador?accion=modificar&idProducto=${producto.idProducto}"
